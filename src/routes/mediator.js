...
<div>
     ...
     <table style={{border:"1px  solid black"}}>
      ...
      <td  style={{border:"1px  solid black"}} >  Id </td>
        <td  style={{border:"1px  solid black"}} >Mediator Name </td>
        ...
        <td  style={{border:"1px  solid black"}} >Phone number </td>
               ...
               {data.map(med_id=>{
                 return (
                  ...
                  <tr>
                  <td  style={{border:"1px  solid black"}} >{med_id.id} </td>
                  <td  style={{border:"1px  solid black"}} >{med_id.name}</td>
                  <td  style={{border:"1px  solid black"}} >{med_id .email}</td>
                  <td  style={{border:"1px  solid black"}} >  {med_id .mobile} </td>
